  ...
  onMount(async () => {
    ...
    try {
      ...
      if (
          ...
          Array.isArray(design.chapters_topics) &&
          design.chapters_topics.length > 0
      ) {
...
<div class="flex min-h-screen max-w-5xl mx-auto bg-white">
  <!-- Main content -->
