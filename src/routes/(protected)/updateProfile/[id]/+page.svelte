<script>
  ...
  $: canUpdatePassword = !!(
    ...
    (isAdmin ||
      (currentUserId && userId && currentUserId.toString() === userId))
  );
  ...
  <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    {:else}
      ...
      <div class="bg-white shadow-xl rounded-lg overflow-hidden">
        <!-- User Info Section -->
        <div
          class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-6 border-b border-gray-200"
        >
        ...
        <div class="px-6 py-6 border-b border-gray-200">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              >
              <div
                class="px-3 py-2 border border-gray-300 rounded-lg bg-gray-50"
              >
          ...
          <form on:submit={handleSubmit} class="space-y-6">
            ...
            <div>
              ...
              <div class="relative">
                <input
                  ...
                  disabled={loading}
                  class="w-full px-3 py-2 pr-20 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed transition-colors duration-200 {validationErrors.new_password
                    ...
                    {#if showPassword}
                      ...
                      >
                        <path
                          ...
                          stroke-linejoin="round"
                          stroke-width="2"
                          d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L12 12m-2.122-2.122L7.76 7.76M12 12l2.122 2.122m-2.122-2.122L9.878 14.878M12 12l4.242-4.242M9.878 14.878L12 17m-2.122-2.122L7.76 16.24"
                        />
                      </svg>
                    {:else}
                      <svg
            ...
            <div>
              ...
              <div class="relative">
                <input
                  ...
                  disabled={loading}
                  class="w-full px-3 py-2 pr-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed transition-colors duration-200 {validationErrors.confirm_password
                    ? 'border-red-300 focus:ring-red-500 focus:border-red-500'
                    : ''}"
            ...
            >
              ...
              <button
                ...
                class="px-4 py-2 text-sm font-medium text-white bg-primary border border-transparent rounded-lg hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
              >
                {#if loading}
                  <div class="flex items-center">
