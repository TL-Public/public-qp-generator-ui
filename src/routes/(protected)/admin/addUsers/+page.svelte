<script>
  ...
  function handleUserCreated(event) {
    ...
    goto('/admin?userCreated=true&message=' + encodeURIComponent(message));
  }
...
<div class="min-h-screen bg-gray-50 py-8">
  <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
      ...
      <p class="mt-2 text-gray-600">Create a new user account with system-generated credentials</p>
    </div>
