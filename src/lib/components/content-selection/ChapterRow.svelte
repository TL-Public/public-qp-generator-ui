<script>
  ...
  $: isHighlighted =
    highlightedItem?.code === chapter.code &&
    highlightedItem?.type === "chapter";
  $: selectedItems =
    selectionLogic?.getSelectedItemsForChapter?.(chapter, selections) || [];
  ...
  <td class="px-6 py-4 whitespace-nowrap">
    <div class="flex items-center">
      ...
      <input
        ...
        class="h-4 w-4 text-primary focus:ring-blue-500 border-gray-300 rounded mr-3"
    ...
    <div class="flex items-center justify-between">
      ...
      {:else if selectedItems.length > 0}
        <div class="flex items-center space-x-2">
          ...
          <button
            type="button"
            class="text-xs text-primary hover:text-blue-800 underline"
