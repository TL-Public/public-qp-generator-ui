...
<div class=" rounded-lg p-6 mb-6 border border-stroke">
  ...
  <!-- <div class="flex justify-end space-x-3 mt-8">
    ...
    <button
      ...
      class="inline-flex items-center px-6 py-2 text-sm font-medium text-white bg-primary border border-transparent rounded-md shadow-sm hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
    >
      <svg
        class="w-4 h-4 mr-2"
        fill="none"
