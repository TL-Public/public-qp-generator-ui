arma/Desktop/Desktop/Internship project/my-app/src/lib/components/Admin/UserEditForm.svelte -->
<script>
        ...
        {#if user}
          <div class="flex items-center space-x-3">
            ...
            <div class="text-right">
              ...
              <div class="text-xs text-gray-500">{user.role_name || 'Unknown Role'}</div>
            </div>
          </div>
        {/if}
      </div>
      ...
      <div class="mb-6 p-4 bg-indigo-50 border border-indigo-200 rounded-lg">
        <div class="flex items-center justify-between mb-4">
          <div class="flex items-center">
            ...
            <h4 class="text-sm font-medium text-indigo-900">Password Management</h4>
            {#if isAdmin}
