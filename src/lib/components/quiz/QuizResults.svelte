              ...
              <div class="border-t border-gray-200 p-6">
                  ...
                  {#if result.question.chapter || result.question.topic}
                    ...
                    >
                      {#if result.question.chapter}
                        <span
                          >📚 {safeDisplayText(result.question.chapter)}</span
                        >
                      {/if}
                      ...
                      <span class="capitalize"
                        >{result.question.difficulty}</span
                      >
                    </div>
                  {/if}
                </div>
                ...
                <div class="space-y-3 mb-6">
                  {#each result.question.options as option, optIndex}
                    <div
                      class="flex items-center p-3 rounded-lg border-2 transition-colors
                      {option.is_correct
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex flex-wrap items-center justify-between gap-4">
          <div class="flex flex-wrap gap-3">
            <button on:click={handleRestart} class="primary-btn">
              <svg
                class="w-4 h-4 mr-2"
                fill="none"
                stroke="currentColor"
            ...
            <button on:click={handleBackToSetup} class="secondary-btn">
              <svg
                class="w-4 h-4 mr-2"
                fill="none"
                stroke="currentColor"
          ...
          <div class="flex flex-wrap gap-3">
            <button on:click={downloadResults} class="secondary-btn">
              <svg
                class="w-4 h-4 mr-2"
                fill="none"
                stroke="currentColor"
            ...
            <button on:click={printResults} class="secondary-btn">
              <svg
                class="w-4 h-4 mr-2"
                fill="none"
                stroke="currentColor"
