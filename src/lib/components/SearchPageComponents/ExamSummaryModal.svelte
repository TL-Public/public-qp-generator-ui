            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="bg-gray-50 rounded-lg p-4">
                <div class="flex justify-between items-center">
                  ...
                  <span class="text-sm font-semibold text-gray-900">{examData.exam_name}</span>
                </div>
              </div>
              <div class="bg-gray-50 rounded-lg p-4">
                <div class="flex justify-between items-center">
                  <span class="text-sm font-medium text-gray-500">Exam Code</span>
                  <span class="text-sm font-semibold text-blue-600">{examData.exam_code}</span>
                </div>
              </div>
              <div class="bg-gray-50 rounded-lg p-4">
                <div class="flex justify-between items-center">
                  <span class="text-sm font-medium text-gray-500">Subject</span>
                  <span class="text-sm font-semibold text-gray-900">{examData.subject}</span>
                </div>
              </div>
              <div class="bg-gray-50 rounded-lg p-4">
                <div class="flex justify-between items-center">
                  <span class="text-sm font-medium text-gray-500">Standard/Class</span>
                  <span class="text-sm font-semibold text-gray-900">{examData.standard}</span>
                </div>
              </div>
              <div class="bg-gray-50 rounded-lg p-4">
                <div class="flex justify-between items-center">
                  <span class="text-sm font-medium text-gray-500">Medium</span>
                  <span class="text-sm font-semibold text-gray-900">{examData.medium}</span>
                </div>
              </div>
              <div class="bg-gray-50 rounded-lg p-4">
                <div class="flex justify-between items-center">
                  <span class="text-sm font-medium text-gray-500">Status</span>
                  <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {examData.status === 'closed' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}">
                    {examData.status}
                  </span>
                </div>
              </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div class="bg-blue-50 rounded-lg p-4 border border-blue-200">
                <div class="text-center">
                  <div class="text-2xl font-bold text-blue-600">{examData.exam_type}</div>
                  <div class="text-sm text-blue-600 font-medium">Exam Type</div>
                </div>
              </div>
              <div class="bg-green-50 rounded-lg p-4 border border-green-200">
                <div class="text-center">
                  <div class="text-2xl font-bold text-green-600 capitalize">{examData.exam_mode}</div>
                  <div class="text-sm text-green-600 font-medium">Exam Mode</div>
                </div>
              </div>
              <div class="bg-purple-50 rounded-lg p-4 border border-purple-200">
                <div class="text-center">
                  <div class="text-2xl font-bold text-purple-600">{examData.total_questions}</div>
