  ...
  >
    ...
    <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
      ...
      <div class="px-6 py-4 overflow-y-auto max-h-[60vh]">
        ...
        <div class="mb-6">
          <h3 class="text-base font-medium text-gray-900 mb-4">Allocation Summary</h3>
          
          <!-- Summary Cards -->
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-3 text-center">
              <div class="text-xl font-bold text-blue-600">{totalRequired}</div>
              <div class="text-sm text-blue-800">Required</div>
            </div>
            <div class="bg-green-50 border border-green-200 rounded-lg p-3 text-center">
              <div class="text-xl font-bold text-green-600">{totalAllocated}</div>
              <div class="text-sm text-green-800">Allocated</div>
            </div>
            <div class="bg-purple-50 border border-purple-200 rounded-lg p-3 text-center">
              <div class="text-xl font-bold text-purple-600">{totalAvailable}</div>
              <div class="text-sm text-purple-800">Available</div>
            </div>
            {#if !allocateWithAI}
            <div class="bg-gray-50 border border-gray-200 rounded-lg p-3 text-center">
              <div class="text-xl font-bold {remaining === 0 ? 'text-green-600' : remaining > 0 ? 'text-amber-600' : 'text-red-600'}">
                {remaining}
              </div>
        ...
        <div class="mb-6">
          <h3 class="text-base font-medium text-gray-700 mb-4">Detailed Allocation Breakdown</h3>
              ...
              {#each selectedItemsWithQuestions as item}
                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <div class="text-right">
                    <div class="text-sm font-bold text-blue-600">{item.questionsToAdd}</div>
